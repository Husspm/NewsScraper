...
app.get("/scrape", function (req, res) {
    request("https://www.nytimes.com/section/science?hpw&rref&action=click&pgtype=Homepage&mo" +
            "dule=well-region&region=bottom-well&WT.nav=bottom-well",
...
app.get("/scrape2", function (req, res) {
    request("https://www.nytimes.com/?action=click&contentCollection=undefined&region=TopBar&" +
            "module=HomePage-Button&pgtype=sectionfront",
    function (error, response, html) {
        var $ = cheerio.load(html);
